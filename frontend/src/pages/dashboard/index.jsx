          ...
          <div className={styles.scrollComponent}>
           ...
           <div className={styles.wrapper}>
            <div className={styles.createPostContainer}>
              ...
              />
              <textarea onChange={(e)=>setPostContent(e.target.value)} value={postContent} className={styles.textAreaOfContent} placeholder={"What's in your mind?"}></textarea>
            ...
            <div className={styles.postContainer}>
              ...
              {postState.posts.map((post) => {
                return (
                  ...
                  }} key={post._id} className={styles.singleCard}>
             ...
             <div onClick={()=>{
              ...
              <div onClick={(e)=>{
                ...
                {postState.comments.length!==0 && 
                    <div>
                      {postState.comments.map((postComment,index)=>{
                        return(
                          <div key={postComment._id} className={styles.singleCommentContainer}>
                            <div>
                              {/* <img src={`${BASE_URL}/${postComment.userId.profilePicture}`} /> */}
                              <div>

                                <p className={styles.commentName}>{postComment.userId.name}</p>
                                <p className={styles.commentuserName}>@{postComment.userId.username}</p>
                ...
                <div className={styles.postCommentContainer}>
                  ...
                  <input value={commentText} placeholder="Comment" onChange={(e)=>setCommentText(e.target.value)}/>
